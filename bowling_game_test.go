...
func TestBowlingGame(t *testing.T) {
	...
	t.Run("When we start a new game AND we roll twice THEN the score is equal to the sum of rolls", func(t *testing.T) {
		bowlingGame := BowlingGame{}
	...
	t.Run("When we roll a strike (10 pins) THEN we can not roll again in the same frame", func(t *testing.T) {
		bowlingGame := BowlingGame{}
